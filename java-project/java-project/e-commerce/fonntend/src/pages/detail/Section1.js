...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	  <div> <a href="#"> <img src={require("../../assets/images/items/q3.jpg")} /></a></div>
	</div>
	<div class="thumbs-wrap">
	  <a href="#" class="item-thumb"> <img src={require("../../assets/images/items/U3.jpg")} /></a>
	  <a href="#" class="item-thumb"> <img src={require("../../assets/images/items/U4.jpg")} /></a>
	  <a href="#" class="item-thumb"> <img src={require("../../assets/images/items/U6.jpg")} /></a>
...
<h2 class="title mt-3"> Mẫu phụ kiện trang sức bán chạy </h2>
